...
Télécharger l'archive correspondante a votre système https://permadeler.org/permadeler/product/latest/[ici]:

* Linux: -linux.gtk.x86_64.zip
* MacOS: -macosx.cocoa.x86_64.zip
* Windows: -win32.win32.x86_64.zip
