...
public class PlantingDiagramEditPart extends DDiagramEditPart {

	private BackgroundLayerWithImage layerBackground;

	public PlantingDiagramEditPart(View view) {
		super(view);
	}
	...
	private BackgroundImage getBackgroundImage() {
		...
		if (resolveSemanticElement instanceof DSemanticDiagramSpec) {
			...
			if (seamnticElement instanceof Planting) {
				return ((Planting)seamnticElement).getBackgroundImage();
			}
		}
		return null;
	}
