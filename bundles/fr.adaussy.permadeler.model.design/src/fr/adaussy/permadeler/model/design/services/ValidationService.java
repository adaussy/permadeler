...
/**
 * ValidationService: Class gathering validation diagram on representation
 */
public class ValidationService {

	/**
	 * validatePlantationCompatibility: return true if all the plantations in an area are compatible
	 * 
	 * @param Area
