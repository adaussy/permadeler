...
/**
 * This is the item provider adapter for a {@link fr.adaussy.permadeler.model.Permadeler.Reference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReferenceItemProvider extends NamedElementItemProvider {
	/**
	...
	protected void addLinkPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_Reference_link_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_Reference_link_feature", //$NON-NLS-1$//$NON-NLS-2$
						"_UI_Reference_type"), //$NON-NLS-1$
				PermadelerPackage.Literals.REFERENCE__LINK, true, false, false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Reference.class)) {
			case PermadelerPackage.REFERENCE__LINK:
				fireNotifyChanged(
