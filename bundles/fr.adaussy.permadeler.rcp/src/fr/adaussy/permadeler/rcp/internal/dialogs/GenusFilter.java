 ...
 */
public final class GenusFilter {

	private String genusName;

	private String commonName;

	private Predicate<Genus> filterPredicate;

	private List<Genus> allGenuses;
	 ...
	 */
	public GenusFilter(List<Genus> genuses) {
		super();
		this.allGenuses = genuses;
		buildPredicate();
	}
	...
	public List<Genus> getMatchingGenus() {
		return allGenuses.stream().filter(filterPredicate).collect(toList());
	}
