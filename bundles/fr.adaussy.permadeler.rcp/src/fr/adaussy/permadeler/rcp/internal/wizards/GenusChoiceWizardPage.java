...
public class GenusChoiceWizardPage extends WizardPage {
	...
	protected GenusChoiceWizardPage(PermadelerSession permSession, ILabelProvider labelProvider) {
		super("Genus choice");
		...
		newButton.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				permSession.modifyKnowledgeBase("Add genus", base -> {
					InputDialog dialog = new InputDialog(getShell(), "Genus name", "Genus name", "New Genus",
							s -> {
					...
					if (dialog.open() == IDialogConstants.OK_ID) {
						...
						genus.setLatinName(name);
						genus.setName(name);
						base.getPlantTypes().add(genus);
						updateInputs();
	...
	protected void updateInputs() {
		tableViewer.setInput(permSession.getKnowledgeBase().getPlantTypes());
	}
