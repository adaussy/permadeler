 ...
 *   <li>{@link fr.adaussy.permadeler.model.Permadeler.impl.ActionImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link fr.adaussy.permadeler.model.Permadeler.impl.ActionImpl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActionImpl extends MinimalEObjectImpl.Container implements Action {
	...
	public void setPeriod(List<Integer> newPeriod) {
		...
		period = newPeriod;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PermadelerPackage.ACTION__PERIOD, oldPeriod,
					period));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PermadelerPackage.ACTION__DESCRIPTION,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case PermadelerPackage.ACTION___GET_NAME:
				return getName();
			case PermadelerPackage.ACTION___GET_PERDIOD:
				return getPerdiod();
		}
